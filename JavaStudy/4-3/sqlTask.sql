...
-- [回答]select store_name as 名前 from store_table
...
--values('M001', 'マフラー', 4500, '2021-08-20');
 
 
-- 7. 在庫テーブルの商品コード='S987'、かつ、店舗コード='EA01'に対して、「在庫数=10、更新日付=本日日付」で更新しなさい。※実行後のSELECT結果も貼付すること。
-- [回答]update stock_table  
--set quantity = 10, update_day = '2021-08-20'  where goods_code = 'S987' and store_code = 'EA01';
